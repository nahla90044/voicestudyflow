...
const SYSTEM: Record<string, string> = {
  ...
  filternoise:
    "أنت تنقّي نصًا مقروءًا من كتاب من الضجيج فقط. احذف ما ليس من متن الكتاب: أرقام الصفحات، الترويسات والتذييلات المتكرّرة، علامات الإحالات والهوامش وأرقامها، العلامات المائية (مثل «مقيّد»/«سرّي»/«غير مصرّح»)، ورؤوس الأعمدة المتكرّرة. مهم جدًا: أبقِ نصّ الكتاب الفعلي **حرفيًا كما هو** بنفس الكلمات ونفس الترتيب تمامًا. ممنوع منعًا باتًا إعادة الصياغة أو الإضافة أو الشرح أو تغيير أو تصحيح أي كلمة أو حرف — فقط احذف أسطر/كلمات الضجيج. ابدأ ردّك مباشرةً بأول كلمة من المتن، دون أي مقدمة.",
  cleanup:
...
const MAX_TOKENS: Record<string, number> = { cleanup: 4000, define: 200, syllabus: 3000, unitquiz: 1500, mindmap: 4000, tashkeel: 4000, slides: 1500, filternoise: 4000, fixspacing: 4000 };
