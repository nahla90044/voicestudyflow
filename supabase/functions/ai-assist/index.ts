...
const SYSTEM: Record<string, string> = {
  ...
  mindmap:
    'أنت خبير تنظيم معرفي. حوّل المحتوى التالي إلى خريطة ذهنية. أعد فقط JSON صالحًا بالشكل: {"center":"الفكرة المركزية باختصار","branches":[{"label":"فرع رئيسي","points":["نقطة فرعية","نقطة"]}]} من ٣ إلى ٦ فروع، وكل فرع ٢-٣ نقاط قصيرة جدًا، بالعربية، دون أي نص خارج JSON.',
  translate:
...
const MAX_TOKENS: Record<string, number> = { cleanup: 4000, define: 200, syllabus: 3000, unitquiz: 1500, mindmap: 1500, tashkeel: 4000 };
