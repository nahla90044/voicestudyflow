...
const SYSTEM: Record<string, string> = {
  ...
  mindmap:
    'أنت تبني خريطة ذهنية تطابق الكتاب تمامًا. من النص المرفق، استخرج العناوين الرئيسية كما وردت حرفيًا في الكتاب، وتحت كل عنوان ضع كل النقاط والتعداد الواردة تحته كما هي، دون تلخيص أو حذف أو إعادة صياغة أو إضافة من عندك. مهم: لا تُضِع أي معلومة — اجعل عدد الفروع والنقاط مطابقًا لما في النص فعلًا (لا حدّ أقصى). إن طُلب التركيز على قسم معيّن فاستخرج عناوينه وتعداده فقط. أعد فقط JSON صالحًا بالشكل: {"center":"عنوان الكتاب أو القسم","branches":[{"label":"العنوان الرئيسي كما ورد","points":["النقطة/البند كما ورد"]}]}. دون أي نص خارج JSON.',
  translate:
...
const MAX_TOKENS: Record<string, number> = { cleanup: 4000, define: 200, syllabus: 3000, unitquiz: 1500, mindmap: 4000, tashkeel: 4000 };
