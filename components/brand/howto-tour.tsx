...
const STEPS: Step[] = [
  {
    emoji: "📚",
    title: "مكتبتك",
    body: "كل كتبك هنا. اضغطي كتابًا لفتح منهجه ثم «ابدأ القراءة». الضغط المطوّل يفتح المجلدات والخيارات.",
  },
  {
    emoji: "📋",
    title: "المنهج الدراسي",
    body: "لكل كتاب منهج بوحدات وقائمة متابعة (تشيك ليست)، مع اختبار وخريطة ذهنية وملخّص صوتي لكل وحدة. ومنه تدخلين للقراءة.",
  },
  {
    emoji: "🎧",
    title: "القراءة الصوتية",
    body: "القارئ يقرأ لكِ بصوت طبيعي ويشرح. تحكّمي بالسرعة، وتنقّلي بين المقاطع (السابق/التالي)، ويكمل من نفس موضعك.",
  },
  {
    emoji: "🔍",
    title: "العدسة المكبّرة",
    body: "فعّلي العدسة لتكبير النص المقروء، وتتابع الكلمة سطرًا بسطر مع صوت القارئ.",
  },
  {
    emoji: "🗣️",
    title: "النطق والترجمة",
    body: "نطق دقيق بالتشكيل، وترجمة فورية، وأصوات عربية وإنجليزية وفرنسية — اختاري ما يناسبك.",
  },
  {
    emoji: "🛠️",
    title: "أدوات الذكاء",
    body: "لخّصي الصفحة، اسألي عنها، أنشئي بطاقات مراجعة، خريطة ذهنية، وعرضًا تقديميًا — كلها بضغطة.",
  },
];
