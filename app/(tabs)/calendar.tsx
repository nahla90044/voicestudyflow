...
const styles = StyleSheet.create({
  ...
  chartTitle: { color: "#fff", fontWeight: "900", textAlign: "right" },
  chartPct: { color: "#c9d4e2", fontWeight: "900" },
  ...
  sectionTitle: { color: "#c9d4e2", fontWeight: "900" },
  ...
  sheetTitle: { color: "#fff", fontWeight: "900", fontSize: 18, textAlign: "right" },
  sheetMeta: { color: "#c9d4e2", textAlign: "right", marginTop: 8 },
